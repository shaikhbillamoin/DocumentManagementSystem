...
namespace DocumentManagementSystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            _userManager.Options.SignIn.RequireConfirmedPhoneNumber = false;
            _userManager.Options.Lockout.AllowedForNewUsers = false;
            _userManager.Options.Lockout.MaxFailedAccessAttempts = 50;
